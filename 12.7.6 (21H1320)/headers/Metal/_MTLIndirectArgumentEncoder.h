...
- (void)dealloc;
- (void)setFunctionPointer:(id)pointer atIndex:(unsigned long long)index;
- (void)setFunctionPointers:(const id *)pointers withRange:(struct _NSRange { unsigned long long x0; unsigned long long x1; })range;
