...
+ (signed char)deserializeHashesFromAIRNTHeaderAtOffset:(unsigned long long)offset headerSize:(unsigned long long)size reader:(id /* block */)reader handler:(id /* block */)handler;
