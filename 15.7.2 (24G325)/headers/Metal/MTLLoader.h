...
+ (signed char)deserializePipelinesFromAIRNTHeaderAtOffset:(unsigned long long)offset headerSize:(unsigned long long)size singleHeaderExpected:(_Bool)expected reader:(id /* block */)reader errorHandler:(id /* block */)handler handler:(id /* block */)handler;
